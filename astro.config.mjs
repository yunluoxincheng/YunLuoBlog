...
export default defineConfig({
	...
	// Astro 自有选项：勿放在 vite.build。never = 样式一律走 <link>，避免 auto 内联小片段导致与 dev 的 cascade/顺序不一致
	build: {
	...
	integrations: [
		...
		swup({
			...
			accessibility: true,
			// 与 dev 行为一致：生产若开启 updateHead，Swup 切页会替换 head 内样式，易出现与开发（HeadTags 中强制 false）不同的布局/样式
			updateHead: false,
	...
	vite: {
		...
		build: {
			...
			// 单文件 CSS，减少生产构建多 chunk 并行加载时的层叠顺序与 dev 不一致（Astro 已支持该选项）
			cssCodeSplit: false,
			cssMinify: "esbuild",
