...
import { getRuntimeTOCConfig } from "../utils/runtime-toc-config";
...
export function getTOCConfig(): {
	...
	const siteConfig = getRuntimeTOCConfig();
	return {
		depth: siteConfig.depth,
		useJapaneseBadge: siteConfig.useJapaneseBadge,
	};
}
